...
public class ExtractDataFromCineticketTest {
	private Logger log = (Logger) Logger.getLogger(this.getClass());
	
	@Autowired
	@Qualifier("procesoCineticketDataExtractionManager")
	private MetaProceso procesoCineticketDataExtractionManager;
	...
	public void testCineticketDataExtraction() throws EtlExecutorException, JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException, ParseException {
		Proceso proceso = procesoCineticketDataExtractionManager.ejecutarProceso();
		proceso.setCodigo(procesoCineticketDataExtractionManager.getCodigo());
		proceso.run();
